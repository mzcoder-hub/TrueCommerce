...
import { listOrdersDelivered } from '../../actions/orderActions'
          ...
          <Card style={{ marginTop: 5 }} key={key}>
            ...
            <CardContent>
              ...
              <Grid container spacing={2} key='bottomCard'>
                <Grid item xs={3} key={`OrderRating$key`}>
                  rating
                </Grid>
                ...
                <Grid item xs={3} key={`ButtonReorder$key32`}>
                  <Button
                    style={{
                      background: 'rgb(2 2 2)',
                      borderRadius: 3,
                ...
                <Grid item xs={3} key={`ButtonReorder$key3`}>
                  <Button
                    style={{
                      background: 'rgb(2 2 2)',
                      borderRadius: 3,
